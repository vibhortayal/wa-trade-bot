...
- Naming an options structure with a symbol IS a trade in this group (the sender is stating a position they hold): e.g. "Zebra for $AVGO" -> action ADD, instrument "spread", symbol AVGO. A spot/reference price ("spot was around 346.50") goes in "note", NEVER in "price" (price is the option premium). Strike/expiry/premium unknown -> null, confidence "low", explain what's missing in "note".
